Hi, I’m **Sergio Verga** – a Data Science MSc (and external research collaborator) with a background in Physics (BSc in Physics - microelectronics). I have experience as a **researcher** (Band Cod. 25CE114) at the University of Milano-Bicocca and doing research at the [Intelligent Sensing Lab (ISLab)](https://islab.disco.unimib.it/) and as a Data Scientist intern in KNIME (Berlin). My main interests include: **Reinforcement Learning** (& Robotics), **Deep Learning** and **Natural Language Processing**. I'm passionate about bridging cutting-edge AI techniques with real-world applications, especially in automation, robotics, and intelligent systems. Let’s connect on [LinkedIn](https://www.linkedin.com/in/sergio-verga-5b071b2b6) or check out some of my work below!
